...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CUTENSOR_CUDA101_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c2b537fd-2c7d-5f1c-8e77-78945a4d1c3a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CUTENSOR_CUDA101", artifacts_toml) for e in artifacts["CUTENSOR_CUDA101"]]
...
if best_platform === nothing
    @debug("Unable to load CUTENSOR_CUDA101; unsupported platform $(triplet(platform_key_abi()))")
else
